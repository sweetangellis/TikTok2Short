...
class ProcessTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.color_slider = SliderWithSpinBox(0.5, 2.0, 
                                             self.config.get("processing.color_saturation", 1.2),
                                             0.1, 1)
        ...
        self.brightness_slider = SliderWithSpinBox(0.5, 2.0, 
                                                 self.config.get("processing.brightness", 1.1),
                                                 0.1, 1)
        ...
        # Opening zoom pulse
        self.zoom_pulse_slider = SliderWithSpinBox(1.0, 1.2, 
                                                  self.config.get("processing.zoom_pulse", 1.05),
                                                  0.01, 2)
        self.zoom_pulse_slider.valueChanged.connect(
            lambda val: self.config.set("processing.zoom_pulse", val))
        enhance_layout.addRow("Zoom Pulse Effect:", self.zoom_pulse_slider)
